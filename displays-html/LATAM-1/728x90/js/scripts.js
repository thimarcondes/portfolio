...
function iniciaAd() {
  ...
  function step1() {
    ...
    TweenMax.to('.background', 0.6, {right: -296, ease: Power2.easeOut, delay: 6.4});
    TweenMax.to(box, 0.6, {width: 728, ease: Power2.easeOut, delay: 6.4});
    TweenMax.to(txtIntro_3, 0.5, {opacity: 1, y: 0, ease: Back.easeOut.config(2), delay: 6.6});
    TweenMax.to(txtIntro_4, 0.5, {opacity: 1, y: 0, ease: Back.easeOut.config(2), delay: 6.8});
    TweenMax.to(txtIntro_5, 0.5, {opacity: 1, y: 0, ease: Back.easeOut.config(2), delay: 7});
  }

  //step2
  function step2() {
    TweenMax.to(txtIntro_3, 0.5, {opacity: 0, y: 60, ease: Back.easeOut.config(2), delay: 0.1});
    TweenMax.to(txtIntro_4, 0.5, {opacity: 0, y: 60, ease: Back.easeOut.config(2), delay: 0.2});
    TweenMax.to(txtIntro_5, 0.5, {opacity: 0, y: 60, ease: Back.easeOut.config(2), delay: 0.3});

    TweenMax.to(up, 0.9, {y: -265, x: 706, ease: Power2.easeOut, delay: 0.6});
    TweenMax.to(dn, 0.9, {x: 56, ease: Power2.easeOut, delay: 0.7});
    TweenMax.to(box, 0.9, {x: 728, ease: Power2.easeOut, delay: 0.6});
    TweenMax.to(latam1, 0.5, {width: 100, y: 5, x: 68, ease: Power2.easeOut, delay: 0.8});
