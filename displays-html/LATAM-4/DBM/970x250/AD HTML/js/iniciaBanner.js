...
function zeraAnimacao(){
	...
	TweenMax.to('.background img', 0, { y:0});
	...
	TweenMax.to('.box_left img', 0, { y:20, opacity:0});
	
	TweenMax.to('.box_azul', 0, { opacity:1});
...
function iniciaAnimacao(){
	...
	TweenMax.to('.logo_one_world img', 1, {opacity: 1, ease: Power0.easeNone, delay:1});
	TweenMax.to('.logo_one_world img', 1, {x: 0, ease: Power2.easeOut, delay:1});

	TweenMax.to('.logo_latam img', 1, {opacity: 1, ease: Power0.easeNone, delay:1.2});
	TweenMax.to('.logo_latam img', 1, {x: 0, ease: Power2.easeOut, delay:1.2});

	TweenMax.to('.slogan', 1, {opacity: 1, ease: Power0.easeNone, delay:.6});
	TweenMax.to('.slogan', 1, {x: 0, ease: Power2.easeInOut, delay:.6});

	TweenMax.to('.footer', 1.5, {y:0, ease: Power2.easeOut, delay:2.2});
	TweenMax.to('.footer img', 1.5, {y:0, ease: Power2.easeOut, delay:2.4});

	TweenMax.to('.background img', 8, {y:-70, ease: Power2.easeOut, delay:0});

	TweenMax.to('.box_left img:nth-child(1)', 1, {y: 0, opacity: 1, ease: Power2.easeOut, delay:.4});
	TweenMax.to('.box_left img:nth-child(2)', 1, {y: 0, opacity: 1, ease: Power2.easeOut, delay:.6});
	
	TweenMax.to('.box_azul', 1, {opacity: 1, ease: Power0.easeNone, delay:4.5});

	TweenMax.to('.box_right img:nth-child(1)', 1, {y: 0, opacity: 1, ease: Power2.easeOut, delay:.8});
	TweenMax.to('.box_right img:nth-child(2)', 1, {y: 0, opacity: 1, ease: Power2.easeOut, delay:1});
	TweenMax.to('.box_right img:nth-child(3)', 1, {y: 0, opacity: 1, ease: Power2.easeOut, delay:1.1});
	TweenMax.to('.box_right img:nth-child(4)', 1, {y: 0, opacity: 1, ease: Power2.easeOut, delay:1.4});

	TweenMax.to('.box_vermelho', 2, {y:-9, ease: Power2.easeInOut, delay:4.4});

    // CTA
    TweenMax.to('.cta', 0, { css:{'pointer-events': 'all'}, delay:1.8});
	TweenMax.to('.cta', .3, { scale:1, ease: Back.easeOut.config(1.6), delay:1.8});
	TweenMax.to('.cta img', .3, { scale:1, ease: Back.easeOut.config(1.6), delay:2});
