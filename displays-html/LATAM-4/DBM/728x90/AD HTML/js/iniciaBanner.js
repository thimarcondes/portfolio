...
function iniciaAnimacao(){
	...
	TweenMax.to('.footer', 1.5, {y:0, ease: Power2.easeOut, delay:2.6});
	TweenMax.to('.footer img', 1.5, {y:0, ease: Power2.easeOut, delay:2.8});

	TweenMax.to('.background img', 5, {y:-50, ease: Power2.easeOut, delay:0});
