...
function zeraAnimacao(){
	...
	TweenMax.to('.background img', 0, { x:24, y:0, scale:1.2});
...
function iniciaAnimacao(){
	...
	// TweenMax.to('.background img', 6, {x:-38, ease: Power2.easeInOut, delay:0});
	...
	TweenMax.to('.texto_top01 img:nth-child(2)', 1, {opacity: 1, ease: Power0.easeNone, delay:1});
	TweenMax.to('.texto_top01 img:nth-child(2)', 1, {y: 1, ease: Power2.easeOut, delay:1});

	TweenMax.to('.texto_top01 img:nth-child(1)', 1, {opacity: 0, ease: Power0.easeNone, delay:3.8});
	TweenMax.to('.texto_top01 img:nth-child(2)', 1, {opacity: 0, ease: Power0.easeNone, delay:4});

	// TweenMax.to('.footer', .8, {y:60, ease: Power2.easeIn, delay:4.2});
	...
	TweenMax.to('.box_azul img:nth-child(1)', 1, {y: 0, opacity: 1, ease: Power2.easeOut, delay:4.6});
	TweenMax.to('.box_azul img:nth-child(2)', 1, {y: 0, opacity: 1, ease: Power2.easeOut, delay:4.7});
