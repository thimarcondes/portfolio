...
function iniciaAd() {
  ...
  function step1() {
    ...
    TweenMax.to(txtIntro_2, 0.5, {opacity: 0, y: 60, ease: Back.easeOut.config(2), delay: 6.1});
    TweenMax.to(txtIntro_3, 0.5, {opacity: 0, y: 60, ease: Back.easeOut.config(2), delay: 6});
    //
    TweenMax.to(box, 0.5, {opacity: 1, ease: Back.easeOut.config(1), delay: 6.5});
  ...
  function step2() {
    ...
    //TweenMax.to(txtIntro_4, 0, {y: 25, x: 71, ease: Power2.easeOut, delay: 0});
    //TweenMax.to(txtIntro_5, 0, {y: 25, x: 71, ease: Power2.easeOut, delay: 0});
    //TweenMax.to(txtIntro_6, 0, {y: 25, x: 71, ease: Power2.easeOut, delay: 0});


    TweenMax.to(".background", 0.5, {x: -365, ease: Power2.easeOut, delay: 0.1});
    TweenMax.to("#h_step1_2", 0.5, {x: -255, ease: Power2.easeOut, delay: 0.2});

    TweenMax.to(cta, 0.5, {scale: 1, opacity: 1, ease: Power2.easeOut, delay: 0.4});
  }

  TweenMax.delayedCall(0, step1);
  TweenMax.delayedCall(11, step2);
}
