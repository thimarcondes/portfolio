...
function iniciaAd() {
  ...
  function step2() {
    ...
    TweenMax.to(txtIntro_4, 0, {y: 155, x: 7, ease: Power2.easeOut, delay: 0});
    TweenMax.to(txtIntro_5, 0, {y: 155, x: 7, ease: Power2.easeOut, delay: 0});
    TweenMax.to(txtIntro_6, 0, {y: 155, x: 7, ease: Power2.easeOut, delay: 0});
