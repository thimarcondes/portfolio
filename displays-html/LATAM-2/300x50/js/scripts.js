...
function iniciaAd() {
  ...
  function step1() {
    ...
    TweenMax.to(txt1, 0.5, {opacity: 0, y: 30, ease: Power2.easeOut, delay: 8.1});
    TweenMax.to(txt3, 0.5, {opacity: 1, y: 0, ease: Power2.easeOut, delay: 8.9});
    TweenMax.to(txt3, 0.5, {opacity: 0, y: 30, ease: Power2.easeOut, delay: 11.3});
      //TweenMax.to(barra, 0.5, {opacity: 0, ease: Power2.easeOut, delay: 9.2});
      //TweenMax.to(txt4, 0.5, {opacity: 1, y: 0, ease: Power2.easeOut, delay: 9.8});
      //TweenMax.to(txt5, 0.5, {opacity: 1, y: 0, ease: Power2.easeOut, delay: 9.6});
    TweenMax.to(latam1, 0.5, {opacity: 0, y: 30, ease: Power2.easeOut, delay: 11.9});
    TweenMax.to(logo, 0.5, {opacity: 0, y: 30, ease: Power2.easeOut, delay: 12.0});
  }
  ...
  TweenMax.delayedCall(12.4, step2);
}
